...
\begin{NoHyper}\bibentry{COLIBRITAFINAL}\end{NoHyper}
...
OpenSubtitles 2012\footnote{\url{http://www.opensubtitles.org}}
...
\emph{colibrita}.\footnote{\emph{colibrita} is written in Python 3, is open source
  ...
  Colibrita dependents on \emph{colibri-core} and \emph{colibri-mt}, both obtainable from the same github source, version tag \texttt{colibrita-v0.3.1} represents the state at
  the time of research.
  }
All input and output data of our experiments is also available for
download. \footnote{Available through Academic Torrents: \url{http://academictorrents.com/details/ab6e61059b7f7879e027ca33fb0f9e82980cd855} }
...
disambiguation in Chapter~\ref{chap:clwsd} show that these global keywords do not
...
SemEval 2010 data (Section~\ref{sec:wsd1}) did. We suspect this may be
...
\hline
l1r1\footnotesize{-moses} & 0.625 & 0.736$*$ \\%& 0.874 \\
l1r1\footnotesize{-mosescut0.7} & 0.657 & 0.761$*$ \\%& 0.9111 \\
%l1r1\footnotesize{-mosescut0.8 & 0.6526 & 0.7563 & 0.9097 \\
%l1r1\footnotesize{-mosescut0.9 & 0.6486 & 0.7531 & 0.9081 \\
l1r1\footnotesize{-mosesweighted} & 0.610 & 0.724$*$ \\%& 0.8672 \\
l2r1\footnotesize{-moses} & 0.647 & 0.755$*$ \\%& 0.885 \\
l2r1\footnotesize{-mosescut0.7} & \textbf{0.669} & \textbf{0.774}$*\ddagger$ \\%& 0.9128 \\
%l2r1\footnotesize{-mosescut0.8 & 0.6667 & 0.7715 & 0.9118 \\
%l2r1\footnotesize{-mosescut0.9 & 0.6606 & 0.7663 & 0.9097 \\
l2r1\footnotesize{-mosesweighted} & 0.635 & 0.744$*$ \\%& 0.8795 \\
l2r2\footnotesize{-moses} & 0.649 & 0.756$*$ \\%& 0.8906 \\
%l2r2\footnotesize{-mosescut0.7 & \textbf{0.6727} & 0.7733 & 0.9141 \\
%l2r2\footnotesize{-mosescut0.8 & \textbf{0.6727} & 0.7731 & 0.9138 \\
%l2r2\footnotesize{-mosescut0.9 & 0.6667 & 0.7679 & 0.9117 \\
%l2r2\footnotesize{-mosesweighted & 0.6386 & 0.7464 & 0.8867 \\
l3r3\footnotesize{-moses} & 0.657 & 0.756$*$ \\%& 0.8979 \\
...
\hline
l1r1\footnotesize{-moses} & 0.603 & 0.672$*\ddagger$ \\%& 0.8793 \\ %recall: 0.998
l1r1\footnotesize{-mosescut0.7} & 0.681 & 0.739$*$ \\%& 0.9086 \\
%l1r1\footnotesize{-mosescut0.8 & 0.6774 & 0.7357 & 0.9077 \\
%l1r1\footnotesize{-mosescut0.9 & 0.6754 & 0.736 & 0.9071 \\
l1r1\footnotesize{-mosesweighted} & 0.569 & 0.651$\ddagger$ \\%& 0.8704 \\
l2r1\footnotesize{-moses} & 0.619 & 0.685$*\ddagger$ \\%& 0.8847 \\
l2r1\footnotesize{-mosescut0.7} & \textbf{0.689} & \textbf{0.748}$*$ \\%& \textbf{0.9106} \\
%l2r1\footnotesize{-mosescut0.8 & 0.6854 & 0.7444 & 0.9094 \\
%l2r1\footnotesize{-mosescut0.9 & 0.6834 & 0.7437 & 0.9088 \\
l2r1\footnotesize{-mosesweighted} & 0.599 & 0.675$*\ddagger$ \\%& 0.8795 \\
l2r2\footnotesize{-moses} & 0.617 & 0.684$*\ddagger$ \\%& 0.8864 \\
l3r3\footnotesize{-moses} & 0.633 & 0.693$*\ddagger$ \\%& 0.8901 \\
\hline
\end{tabular}}
\end{table}
...
\hline
l1r1\footnotesize{-moses} & 0.568 & 0.709$*\ddagger$ \\%& 0.9357 \\ %recall: 0.998
l1r1\footnotesize{-mosescut0.7} & 0.590 & 0.721$*\ddagger$ \\%& 0.938 \\
%l1r1\footnotesize{-mosescut0.8 & 0.5899 & 0.721 & 0.938 \\
%l1r1\footnotesize{-mosescut0.9 & 0.596 & 0.7251 & 0.9388 \\
l1r1\footnotesize{-mosesweighted} & 0.562 & 0.703$*\ddagger$ \\%& 0.9348 \\
l2r1\footnotesize{-moses} & 0.576 & 0.711$*\ddagger$ \\%& 0.9363 \\
l2r1\footnotesize{-mosescut0.7} & 0.588 & 0.717$*\ddagger$ \\%& 0.9368 \\
%l2r1\footnotesize{-mosescut0.8 & 0.5859 & 0.7163 & 0.9366 \\
%l2r1\footnotesize{-mosescut0.9 & 0.5939 & 0.7214 & 0.9376 \\
l2r1\footnotesize{-mosesweighted} & 0.568 & 0.706$*\ddagger$ \\%& 0.9349 \\
l2r2\footnotesize{-moses} & 0.572 & 0.708$*\ddagger$ \\%& 0.9355 \\
%l2r2\footnotesize{-mosescut0.7 & 0.5737 & 0.7054 & 0.9342 \\
%l2r2\footnotesize{-mosescut0.8 & 0.5717 & 0.7044 & 0.934 \\
%l2r2\footnotesize{-mosescut0.9 & 0.5798 & 0.7094 & 0.935 \\
%l2r2\footnotesize{-mosesweighted & 0.5596 & 0.6974 & 0.9335 \\
l3r3\footnotesize{-moses} & 0.570 & 0.707$*\ddagger$ \\%& 0.9347 \\
...
\hline
l1r1\footnotesize{-moses} & 0.487 & 0.647$*\ddagger$ \\%& 0.9262 \\%recall: 1.0
l1r1\footnotesize{-mosescut0.7} & \textbf{0.548} & 0.686$*$ \\%& 0.9333 \\
%l1r1\footnotesize{-mosescut0.8 & 0.5458 & 0.6851 & 0.9333 \\
%l1r1\footnotesize{-mosescut0.9 & 0.5458 & 0.6851 & 0.9333 \\
l1r1\footnotesize{-mosesweighted} & 0.476 & 0.634$*\ddagger$ \\%& 0.9238 \\
l2r1\footnotesize{-moses} & 0.495 & 0.654$*\ddagger$ \\%& 0.9278 \\
l2r1\footnotesize{-mosescut0.7} & \textbf{0.548} & \textbf{0.687}$*$ \\%& \textbf{0.9335} \\
%l2r1\footnotesize{-mosescut0.8 & 0.5458 & 0.6865 & \textbf{0.9335} \\
%l2r1\footnotesize{-mosescut0.9 & 0.5458 & 0.6865 & \textbf{0.9335} \\
l2r1\footnotesize{-mosesweighted} & 0.489 & 0.647$*\ddagger$ \\%& 0.9265 \\
l2r2\footnotesize{-moses} & 0.495 & 0.653$*\ddagger$ \\%& 0.928 \\
%l2r2\footnotesize{-mosescut0.7 & 0.5419 & 0.6831 & 0.9326 \\
%l2r2\footnotesize{-mosescut0.8 & 0.538 & 0.6816 & 0.9324 \\
%l2r2\footnotesize{-mosescut0.9 & 0.5361 & 0.6797 & 0.9322 \\
%l2r2\footnotesize{-mosesweighted & 0.4951 & 0.651 & 0.9271 \\
l3r3\footnotesize{-moses} & 0.497 & 0.654$*\ddagger$ \\%& 0.928 \\
...
\hline
\textbf{CNRC} \footnotesize{\citep{CNRC}} & 0.745 & 0.717 & 0.694 & 0.610 \\
\textbf{IUCL} \footnotesize{\citep{IUCL}}  & 0.720 & 0.722 & 0.682 & 0.679 \\
\textbf{UEdin} \footnotesize{\citep{UEDIN}}  & \textbf{0.827} &  - & \textbf{0.824} & \textbf{0.692} \\
\textbf{UNAL} \footnotesize{\citep{UNAL}} & 0.809 & - & - & -  \\
\textbf{Sensible} \footnotesize{\citep{SENSIBLE}} & 0.351 & 0.233 & - & - \\
\textbf{TeamZ} \footnotesize{\citep{TEAMZ}} & 0.333 &  0.293 & - & -  \\
\hline
\end{tabular}}
\end{table}
