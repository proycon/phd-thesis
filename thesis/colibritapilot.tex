\chapter[Translation of L1 Fragments in an L2 Context]{Translation Assistance by Translation of L1 Fragments in an L2 Context}
...
In Figure~\ref{fig:algo}, $f_{strongest\_t}$ corresponds to the best scoring
