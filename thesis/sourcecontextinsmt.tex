...
The IWSLT 2006 dataset is characterised by short phrases, whereas other the
other data sets tend to contain longer phrases. We can hypothesize that
source-side context information may have a slight local positive effect that
is, however, lost in translation quality as sentences grow longer and other
local mismatches are made.
