...
These tests do show that our focus on this particular feature in the
...
\hline
%old data, optimized on baseline only:
...
We observe from this data our system does result in a decent amount of
difference in phrase selection. A correlation between translation quality and
the difference ratio of phrase pairs or source phrases, can not be discerned,
however.
...
adding a score shifts the weights for the score vector. Any shift may likely affect the outcome. This
