...
Given the over-all lack of impact above baseline observed across most
...
differs from $p(t|s)$? We compute this on the test data of the JRC-Acquis corpus,
from English to Spanish, as shown in Figure~\ref{fig:scoredifference}. For
training we used a subset of $250,000$ sentences. To ensure measurements are
not due to optimizer differences, we only optimized the decoder
parameters on the baseline and applied those weights to the context-informed
runs as well.
