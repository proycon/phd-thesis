...
control for optimizer instability. We do so by applying the methodology of
\cite{MERTCONTROL}, which runs MERT multiple times, employs
\emph{bootstrap resampling} to compute standard deviations and
\emph{approximate randomization} to compute p-values for the assessment of
statistical significance.\footnote{All this is implemented in the software
\emph{MultEval}, available from \url{https://github.com/jhclark/multeval}}.
