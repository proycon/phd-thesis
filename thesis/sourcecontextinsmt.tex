...
\hline
Baseline  \footnotesize{(replace)}& \textbf{68.9} (0.6/0.1/p=-) & - & 28.3 (0.7/0.1/p=-) \\
...
\hline
\end{tabular}}
\caption{Results on EMEA, English to Spanish and English to Dutch. METEOR scores for the latter were not properly computed due to a glitch in the experiment pipeline.}
\label{tab:emea}
\end{table}
