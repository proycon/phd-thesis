...
\textsc{This chapter is based on: } \emph{TODO} %TODO
...
For BLEU and METEOR, higher scores a better, for TER, however, a lower score
...
critical mass of translation quality or quantity of training material is needed
...
l1r1 (monolithic/replace/tribl2) & 27.7 (1.4/1.1/p=0.01) & \textbf{30.2} (0.7/0.1/p=0.01) & \textbf{55.5} (1.5/1.6/p=0.0) \\ 
l2r1 (monolithic/replace/tribl2) & 27.2 (1.4/0.3/p=0.15) & 29.9 (0.7/0.2/p=0.47) & 56.5 (1.5/0.6/p=0.56) \\ 
l2r2 (monolithic/replace/tribl2) & \textbf{28.0} (1.5/0.4/p=0.0) & 30.0 (0.7/0.2/p=0.26) & 55.8 (1.5/0.6/p=0.02) \\ 
l3r3 (monolithic/replace/tribl2) & 27.2 (1.4/0.3/p=0.28) & 29.8 (0.7/0.1/p=0.95) & 57.6 (1.5/0.4/p=0.06) \\ 
l1r1 (experts/replace/ib1) & 26.6 (1.4/0.2/p=0.58) & \textbf{30.2} (0.7/0.1/p=0.03) & 57.0 (1.5/0.1/p=0.57) \\ 
l2r1 (experts/replace/ib1) & 27.0 (1.4/0.8/p=0.5) & 30.0 (0.7/0.1/p=0.39) & 56.9 (1.5/0.8/p=0.71) \\ 
l2r2 (experts/replace/ib1)& 27.2 (1.4/0.3/p=0.21) & 30.1 (0.7/0.2/p=0.09) & 56.6 (1.5/0.9/p=0.7) \\ 
l3r3 (experts/replace/ib1)& 26.2 (1.4/0.5/p=0.2) & 29.8 (0.7/0.2/p=0.83) & 58.1 (1.5/0.8/p=0.0) \\ 
\hline
Baseline (append) & 26.8 (1.4/0.5/-) & 29.8 (0.7/0.1/-) & 57.2 (1.5/0.6/-) \\ 
l1r1 (monolithic/append/tribl2) & 26.8 (1.4/0.3/p=0.92) & 30.0 (0.7/0.1/p=0.23) & 57.3 (1.5/0.5/p=0.84) \\ 
l2r1 (monolithic/append/tribl2)& 27.6 (1.4/0.2/p=0.01) & 30.2 (0.7/0.0/p=0.04) & 55.9 (1.5/0.2/p=0.0) \\ 
l2r2 (monolithic/append/tribl2)& 27.4 (1.4/0.8/p=0.09) & 29.7 (0.7/0.2/p=0.44) & 57.0 (1.5/0.9/p=0.62) \\ 
l3r3 (monolithic/append/tribl2)& 27.1 (1.4/0.8/p=0.35) & 29.8 (0.7/0.2/p=0.91) & 57.2 (1.5/1.3/p=0.93) \\ 
l1r1 (experts/append/ib1) & 25.9 (1.4/0.5/p=0.02) & 30.0 (0.7/0.0/p=0.34) & 57.6 (1.5/0.7/p=0.37) \\ 
l2r1 (experts/append/ib1) & \textbf{27.9} (1.4/0.2/p=0.0) & \textbf{30.3} (0.7/0.2/p=0.01) & \textbf{55.6} (1.5/0.4/p=0.0) \\ 
l2r2 (experts/append/ib1) & 27.3 (1.4/0.5/p=0.15) & 30.0 (0.7/0.3/p=0.25) & 56.5 (1.5/0.4/p=0.05) \\ 
l3r3 (experts/append/ib1) & 26.3 (1.4/0.7/p=0.25) & 29.5 (0.7/0.1/p=0.14) & 58.7 (1.5/0.4/p=0.0) \\ 
\end{tabular}}
...
of the left respectively right context. In parentheses is the triplet $(\overline{s}_{sel},s_{opt},p}$.
\label{tab:iwslt2006zhen}
\end{table}
\end{savenotes}

Several local context sizes have been attempted. The number after l refers to
the numbers of words to the left of the source phrase. The number after r
denotes the right context size. Further parameters to the system are enclosed
within parentheses.  Recall that the classifiers may be built in two distinct
ways, a single \emph{monolithic} configuration (with \emph{tribl2}), as is used
here, or a classifier \emph{expert} configuration (with \emph{ib1}).  Secondly,
score weighting can be done either through the \emph{replace}  or the
\emph{append} method, as shown in respectively the upper and lower parts of
Table~\ref{tab:iwslt2006zhen}.  In this section we focus exclusively on the
...
later section.  All experiments have been optimised with MERT on BLEU as
described in Section~\ref{sec:paropt}.

For this experiment we see scores over the baselines for all experiments.
However, not all pass the strict significance tests we impose. Only
configurations l1r1/monolithic/replace and l2r1/monolithic/append and
l2r2/experts/append pass the significance tests on all metrics, where we
consider a $p <= 0.05$ to be the pass criterium. Other configurations either do
not pass the significance tests at all, or paint a conflicting picture for
certain metrics. Nevertheless, we can conclude that in this experiment
incorporating source-side context information using machine learning proves
beneficial in at least certain configurations.
...
\textbf{System} & \textsc{BLEU}  & \textsc{METEOR}  & \textsc{TER}  \\ 
\hline 
Baseline (replace) & \textbf{31.3} (0.5/0.2/p=-) & \textbf{32.7} (0.2/0.1/p=-) & 47.9 (0.5/0.6/p=-) \\ 
l2r1 (monolithic/replace/tribl2) & 30.8 (0.5/0.1/p=0.0) & 32.5 (0.2/0.0/p=0.0) & 48.1 (0.5/0.2/p=0.04) \\ 
l2r2 (monolithic/replace/tribl2) & 30.5 (0.5/0.1/p=0.0) & 32.4 (0.2/0.0/p=0.0) & 48.5 (0.4/0.2/p=0.0) \\ 
l3r3 (monolithic/replace/tribl2) & 30.4 (0.5/0.1/p=0.0) & 32.3 (0.2/0.1/p=0.0) & 48.4 (0.4/0.2/p=0.0) \\ 
l1r1 (experts/replace/ib1) & \textbf{31.3} (0.5/0.0/p=0.63) & 32.6 (0.2/0.0/p=0.05) & \textbf{47.1} (0.4/0.3/p=0.0) \\ 
l2r1 (experts/replace/ib1) & 30.9 (0.5/0.1/p=0.0) & 32.5 (0.2/0.0/p=0.0) & 48.3 (0.5/0.1/p=0.0) \\ 
l2r2 (experts/replace/ib1) & 31.0 (0.5/0.1/p=0.0) & 32.5 (0.2/0.1/p=0.0) & 47.9 (0.5/0.1/p=0.82) \\ 
l3r3 (experts/replace/ib1) & 30.8 (0.5/0.2/p=0.0) & 32.4 (0.2/0.1/p=0.0) & 48.2 (0.5/0.4/p=0.04) \\ 
\hline
Baseline (append) & 31.1 (0.5/0.3/p=-) & 32.6 (0.2/0.0/p=-) & 48.1 (0.5/0.7/p=-) \\ 
l2r1 (monolithic/append/tribl2) & 30.8 (0.5/0.1/p=0.0) & 32.4 (0.2/0.0/p=0.0) & 47.4 (0.4/0.4/p=0.0) \\ 
l2r2 (monolithic/append/tribl2) & 30.6 (0.5/0.4/p=0.0) & 32.4 (0.2/0.1/p=0.0) & 48.3 (0.4/1.1/p=0.12) \\ 
l3r3 (monolithic/append/tribl2) & 30.5 (0.5/0.1/p=0.0) & 32.3 (0.2/0.0/p=0.0) & 48.5 (0.4/0.1/p=0.0) \\ 
l1r1 (experts/append/ib1) & \textbf{31.3} (0.5/0.1/p=0.11) & \textbf{32.6} (0.2/0.0/p=0.49) & \textbf{47.1} (0.4/0.5/p=0.0) \\ 
l2r1 (experts/append/ib1) & 30.9 (0.5/0.3/p=0.05) & 32.5 (0.2/0.0/p=0.0) & 47.9 (0.5/0.8/p=0.01) \\ 
l2r2 (experts/append/ib1) & 30.6 (0.5/0.3/p=0.0) & 32.4 (0.2/0.1/p=0.0) & 48.4 (0.5/0.8/p=0.01) \\ 
l3r3 (experts/append/ib1) & 30.7 (0.5/0.2/p=0.0) & 32.4 (0.2/0.0/p=0.0) & 48.3 (0.4/0.2/p=0.08) \\ 
\hline
\end{tabular}}
...
We observe we do not manage to surpass the non-context informed baseline with
an acceptable degree of significance in this experiment. 

We move on to larger corpora, such as the EMEA corpus and the JRC corpus, and
run experiments for English to Spanish and in the former case also for English
...
\hline
Baseline (replace/tribl2) & 71.5 (0.5/0.0/p=-) & 80.9 (0.4/0.0/p=-) & 25.8 (0.6/0.0/p=-) \\ 
l1r1 (monolithic/replace/tribl2) & 71.5 (0.5/0.0/p=0.89) & \textbf{81.0} (0.4/0.1/p=0.49) & \textbf{25.7} (0.6/0.1/p=0.02) \\ 
l2r1 (monolithic/replace/tribl2) & 71.5 (0.5/0.0/p=0.43) & 80.9 (0.4/0.0/p=0.75) & 25.8 (0.6/0.1/p=0.78) \\ 
l2r2 (monolithic/replace/tribl2) & 71.5 (0.5/0.1/p=0.65) & 80.9 (0.4/0.1/p=0.62) & 25.8 (0.6/0.1/p=0.44) \\ 
l3r3 (monolithic/replace/tribl2) & 71.5 (0.5/0.0/p=0.72) & 80.9 (0.4/0.1/p=0.93) & 25.8 (0.6/0.1/p=0.32) \\ 
\hline
Baseline (append/tribl2) & 71.5 (0.5/0.0/p=-) & 80.9 (0.4/0.0/p=-) & 25.8 (0.6/0.0/p=-) \\ 
l1r1 (monolithic/append/tribl2) & 71.5 (0.5/0.0/p=0.74) & 80.9 (0.4/0.1/p=0.43) & 25.8 (0.6/0.1/p=0.92) \\ 
l2r1 (monolithic/append/tribl2) & \textbf{71.6} (0.5/0.0/p=0.03) & \textbf{81.0} (0.4/0.0/p=0.42) & 25.8 (0.6/0.1/p=0.39) \\ 
l2r2 (monolithic/append/tribl2) & 71.5 (0.5/0.1/p=0.4) & 80.9 (0.4/0.0/p=0.07) & 25.9 (0.6/0.1/p=0.17) \\ 
l3r3 (monolithic/append/tribl2) & 71.5 (0.5/0.1/p=0.51) & 80.9 (0.4/0.1/p=0.74) & 25.8 (0.6/0.1/p=0.9) \\ 
\hline
\multicolumn{6}{|c|}{EMEA-en-nl} \\
\hline
Baseline (replace/tribl2) & \textbf{68.9} (0.6/0.1/p=-) & \textbf{0.0} (0.0/0.0/p=-) & 28.3 (0.7/0.1/p=-) \\ 
l1r1 (monolithic/replace/tribl2) & \textbf{68.9} (0.6/0.0/p=0.83) & \textbf{0.0} (0.0/0.0/p=0.0) & \textbf{28.2} (0.7/0.0/p=0.04) \\ 
l2r1 (monolithic/replace/tribl2) & 68.8 (0.6/0.0/p=0.28) & \textbf{0.0} (0.0/0.0/p=0.0) & 28.3 (0.7/0.1/p=0.2) \\ 
l2r2 (monolithic/replace/tribl2) & 68.8 (0.6/0.0/p=0.32) & \textbf{0.0} (0.0/0.0/p=0.0) & \textbf{28.2} (0.7/0.1/p=0.03) \\ 
l3r3 (monolithic/replace/tribl2) & \textbf{68.9} (0.6/0.1/p=0.8) & \textbf{0.0} (0.0/0.0/p=0.0) & \textbf{28.2} (0.7/0.0/p=0.01) \\ 
\hline
Baseline (append/tribl2) & 68.8 (0.6/0.1/p=-) & \textbf{0.0} (0.0/0.0/p=-) & 28.3 (0.7/0.0/p=-) \\ 
l1r1 (monolithic/append/tribl2) & \textbf{68.9} (0.6/0.1/p=0.12) & \textbf{0.0} (0.0/0.0/p=0.0) & 28.3 (0.7/0.1/p=0.56) \\ 
l2r1 (monolithic/append/tribl2) & 68.8 (0.6/0.1/p=0.9) & \textbf{0.0} (0.0/0.0/p=0.0) & 28.3 (0.7/0.1/p=0.32) \\ 
l2r2 (monolithic/append/tribl2) & 68.8 (0.6/0.1/p=0.76) & \textbf{0.0} (0.0/0.0/p=0.0) & \textbf{28.2} (0.7/0.1/p=0.02) \\ 
l3r3 (monolithic/append/tribl2) & 68.8 (0.6/0.0/p=0.69) & \textbf{0.0} (0.0/0.0/p=0.0) & \textbf{28.2} (0.7/0.0/p=0.04) \\ 
\hline
\end{tabular}}
...
\textbf{System} & \textsc{BLEU}  & \textsc{METEOR}  & \textsc{TER} \\ 
\hline
\multicolumn{6}{|c|}{JRC-en-es} \\
\hline
Baseline (replace) & 57.6 (0.5/0.2/p=-) & \textbf{73.1} (0.4/0.0/p=-) & 32.7 (0.5/0.2/p=-) \\ 
l1r1 (monolithic/replace/tribl2) & 57.2 (0.5/0.1/p=0.0) & 72.2 (0.4/0.1/p=0.0) & 33.1 (0.5/0.4/p=0.0) \\ 
l2r1 (monolithic/replace/tribl2) & 57.6 (0.5/0.1/p=0.74) & 72.5 (0.4/0.1/p=0.0) & 32.7 (0.5/0.2/p=0.86) \\ 
l2r2 (monolithic/replace/tribl2) & 57.7 (0.5/0.1/p=0.0) & 72.6 (0.4/0.1/p=0.0) & 32.8 (0.5/0.2/p=0.23) \\ 
l3r3 (monolithic/replace/tribl2) & \textbf{57.8} (0.5/0.0/p=0.01) & 72.7 (0.4/0.0/p=0.0) & \textbf{32.5} (0.5/0.2/p=0.0) \\ 
l1r1 (experts/replace/ib1) & 57.2 (0.5/0.1/p=0.0) & 72.1 (0.4/0.0/p=0.0) & 33.4 (0.5/0.2/p=0.0) \\ 
l2r1 (experts/replace/ib1) & 57.0 (0.5/0.4/p=0.0) & 72.2 (0.4/0.1/p=0.0) & 33.5 (0.5/0.4/p=0.0) \\ 
l2r2 (experts/replace/ib1) & 57.6 (0.5/0.2/p=0.26) & 72.5 (0.4/0.1/p=0.0) & 32.8 (0.5/0.4/p=0.03) \\ 
l3r3 (experts/replace/ib1) & \textbf{57.8} (0.5/0.0/p=0.0) & 72.7 (0.4/0.1/p=0.0) & 32.7 (0.5/0.1/p=0.89) \\ 
\hline
Baseline (append) & 57.6 (0.5/0.1/p=-) & \textbf{73.1} (0.4/0.0/p=-) & 32.8 (0.5/0.1/p=-) \\ 
l1r1 (monolithic/append/tribl2) & 57.6 (0.5/0.1/p=0.07) & 72.7 (0.4/0.0/p=0.0) & 32.7 (0.5/0.1/p=0.18) \\ 
l2r1 (monolithic/append/tribl2) & 57.6 (0.5/0.1/p=0.02) & 72.8 (0.4/0.1/p=0.0) & 32.7 (0.5/0.2/p=0.05) \\ 
l2r2 (monolithic/append/tribl2) & 57.5 (0.5/0.1/p=0.25) & 72.7 (0.4/0.1/p=0.0) & 32.9 (0.5/0.0/p=0.04) \\ 
l3r3 (monolithic/append/tribl2) & 57.5 (0.5/0.3/p=0.58) & 72.7 (0.4/0.1/p=0.0) & 32.9 (0.5/0.3/p=0.02) \\ 
l1r1 (experts/append/ib1) & \textbf{57.7} (0.5/0.1/p=0.07) & 72.8 (0.4/0.1/p=0.0) & 32.7 (0.5/0.1/p=0.29) \\ 
l2r1 (experts/append/ib1) & \textbf{57.7} (0.5/0.1/p=0.0) & 72.8 (0.4/0.0/p=0.0) & \textbf{32.6} (0.5/0.2/p=0.0) \\ 
l2r2 (experts/append/ib1) & 57.5 (0.5/0.3/p=0.44) & 72.7 (0.4/0.1/p=0.0) & 32.9 (0.5/0.2/p=0.01) \\ 
l3r3 (experts/append/ib1) & 57.6 (0.5/0.3/p=0.0) & 72.8 (0.4/0.0/p=0.0) & 32.7 (0.5/0.4/p=0.05) \\ 
\hline
\end{tabular}}
...
(experts/append/ib1)} do score slightly above threshold, with statistical
significance, on two out of three metrics.

Surpassing the non-context informed baseline seems a very tough problem. With
the JRC and EMEA corpora, we selected parallel corpora that contain highly
formulaic language. 
...
\hline
Baseline (replace) & \textbf{60.7} (0.6/0.1/p=-) & \textbf{73.9} (0.4/0.0/p=-) & 33.6 (0.6/0.1/p=-) \\ 
l1r1 (monolithic/replace) & 60.3 (0.6/0.1/p=0.0) & 73.7 (0.5/0.0/p=0.0) & \textbf{33.5} (0.6/0.1/p=0.2) \\ 
l2r1 (monolithic/replace) & 60.3 (0.6/0.1/p=0.0) & 73.7 (0.5/0.0/p=0.0) & \textbf{33.5} (0.6/0.1/p=0.2) \\ 
\hline
\multicolumn{4}{|c|}{FryskeAkademy-fy-nl} \\
\hline
Baseline (replace) & \textbf{55.3} (0.7/0.0/p=-) & - & \textbf{28.6} (0.6/0.0/p=-) \\ 
l1r1 (monolithic/replace/tribl2) & 54.9 (0.6/0.0/p=0.0) & -& 28.8 (0.5/0.0/p=0.0) \\ 
l2r1 (monolithic/replace/tribl2) & 54.9 (0.6/0.1/p=0.0) & -& 28.9 (0.6/0.0/p=0.0) \\ 
\hline
\end{tabular}}
...
\hline
Baseline (replace) & \textbf{15.7} (0.3/0.0/p=-) & -& \textbf{72.0} (0.3/0.0/p=-) \\ 
l1r1 (monolithic/replace/tribl2) & 14.7 (0.3/0.0/p=0.0) & -& 73.3 (0.3/0.0/p=0.0) \\ 
l2r1 (monolithic/replace/tribl2) & 15.0 (0.3/0.0/p=0.0) & -& 73.0 (0.3/0.1/p=0.0) \\ 
\hline
\end{tabular}}
...
%TODO: verify that this still holds
Are we placing our bets on the wrong horse by focussing solely on $p(t|s)$ and
replacing it with $p(t|s,C)$? No, the optimised decoder parameters overall
show that this feature receives significantly more weight than the other
...
context-informed system. These phrases are indicative of the SMT decoder
choosing a different translation option than it did for the baseline, due to
the classifier information. Table~\ref{tab:decodediff} shows the results for a
few of the data sets we used. We also show, in the last column, how many of the
source-side fragments are not in the baseline, implying that the SMT decoder
chose a different source-phrase to translate than the baseline did.

\begin{table} %redone with new data (jan 2016)
\noindent\makebox[\textwidth][c]{%
\begin{tabular}{lllcc}
\hline
...
Fryske Akademy & Frisian$\rightarrow$Dutch & l1r1 (M/monolithic/replace) & $41.51\%$ & $40.07\%$ \\
IWSLT 2012 TED & Dutch$\rightarrow$English & l1r1 (M/monolithic/replace) & $43.78\%$ & $30.29\%$ \\
IWSLT 2006 & Chinese$\rightarrow$English & l1r1 (M/monolithic/replace) & $43.78\%$ & $30.29\%$ \\
\hline
\end{tabular}}
...
context information. Notable here is that the EMEA corpus has a higher fraction
...
\texttt{l3r3}), for  IWSLT 2012 TED Dutch-English (Table~\ref{tab:iwslt2012},
...
monolithic classifier. When inspecting the two 250,000 instance samples of
...
We can, however, use the two different scoring methods to provide insight into
the classifier results. How often does the classifier assign a $p(t|s,C)$ that
differs from $p(t|s)$? We compute this the test data of the JRC-Acquis corpus,
from English to Spanish, as shown in Figure~\ref{fig:scoredifference}.

For each occurrence of each source phrase in the test-data, we gathered all
possible translations and compute the difference $\Delta$ between the
context-informed translation probability and the non-context informed one as
per Equation~\ref{eqn:scorediff}.
...
options, and therefore on the hole raises the probability of the remaining
options.
...
\input{scoredifference.tikz}
\input{scoredifference2.tikz}
...
conclusions in previous work. The results of the experiments, however, were
often in contrast with one another; there was a high degree of variability
between the corpora and language pairs. Positive results were attained on EMEA,
for both English to Spanish and English to Dutch, JRC-Acquis (English to
Spanish) and IWSLT 2006 (English to Chinese).  Especially the former two are
highly formulaic corpora, and the touristic ``how to'' domain of the IWSLT 2006
data has formulaic aspects as well, leading us to be cautiously optimistic
source-side context does have merit under certain constraints.
