...
in Tables~\ref{tab:fullresults1} and \ref{tab:fullresults2}, at the end of this chapter,
...
Figures~\ref{fig:graphs} (next page) and \ref{fig:graphs2} (end of next section) show the
...
\begin{figure*}[p]
\noindent\makebox[\textwidth][c]{%
\includegraphics[width=13cm]{en-es-best-2.png}}
\noindent\makebox[\textwidth][c]{%
\includegraphics[width=13cm]{en-de-best-2.png}}
\noindent\makebox[\textwidth][c]{%
\includegraphics[width=13cm]{fr-en-best-2.png}}
...
\noindent\makebox[\textwidth][c]{%
\includegraphics[width=13cm]{nl-en-best-2.png}
}
