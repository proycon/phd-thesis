...
significantly differs from $p(t|s)$? We compute this the
test data of the JRC-Acquis corpus, from English to Spanish, as shown in
...
\begin{cases}
 ...
 -1(\frac{p(t|s)}{p(t|s,C)}) - 1 & \text{otherwise}
\end{cases}
\label{eqn:scorediff}
\end{equation}
...
less sharply than the left hand side, it covers the phrase pairs to which the
classifier assigns a higher probability. No less than $75\%$ of the phrase
pairs are in this region. This is a direct result of the discriminative
