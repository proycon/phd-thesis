...
Most of the tables in the previous section list results for both classifier
...
Despite the results not being unanymous, the case for the classifier experts is
strong and can be motivated by the fact that feature weights are computed o a per-
source-phrase basis, rather than on the conjunction of all. It can be considered as a
...
Whilst we conducted parameter optimisation for the parameter of the SMT
...
The experiments conducted until now have not seen their classifier's optimised
in such way, because this comes with a number of challenges.
