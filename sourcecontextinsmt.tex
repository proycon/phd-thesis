...
We have conducted numerous experiments to assess whether source-side
context-information, without the use of linguistic information, can improve
translation quality. Memory-based classifiers were used to this end, and
integrated in an SMT framework. The results of the experiments were mixed and
there was a high degree of variability between different corpora and language
pairs. Positive results were attained on EMEA and JRC-Acquis. 
