...
\journalname{Machine Translation}
...
previous work. We only observe improvements in translation quality on one
corpus, and generally fail to surpass the non-contxt informed baseline. Lowering the expectations raised by previous work, we conclude that
...
Section~\ref{chap:intromt}. To recap, two models are at the core of
...
\begin{exe} %gb4e package
    \ex \textbf{English:} I don't trust the \textbf{bank}. \\
    \textbf{Spanish:} No me fio del \textbf{banco}.
\label{ex:bank1}

\ex \textbf{English:} The boat headed towards the \textbf{bank} of the river. \\
\textbf{Spanish:} El barco se dirigió hacia la \textbf{orilla} del río.
\label{ex:bank2}
\end{exe}
...
translation model directly improves translation results, as the context helps in
...
evaluation metrics.  Moreover, their approach is word-based and the level of
...
method in the field of Word Sense Disambiguation \citep{SENSEVAL2}, as
demonstrated already in Chapter~\ref{chap:clwsd}).
...
\footnote{\url{https://github.com/proycon/colibri-mt} \\ \texttt{7abeac5a139779ab9c9c4e1b275cf801ed38c232} is the git
commit that represents a fair state of the software version during this study, meaning that it is functionally
equivalent to what was used in most experiments, aside from some minor commits since.}
