...
%TODO: parameter optimisation experiment
...
Two weighting methods have been implemented and used in our experiments, the
\emph{append} method, adding $p(t|s,C)$ as an extra score to the score vector,
and the \emph{replace} method, which replaces the existing $p(t|s)$ score with
$p(t|s,C)$. 
