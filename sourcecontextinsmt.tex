...
pair. A possibly intuitive hypothesis here is that source-side context
modelling stands to gain most when translation from morphologically simpler
languages to morphologically richer languages, as the source-side context
information may help in determining the proper morphological form.
At the least, and more generally put, we can posit that it depends a lot
on the particular data used, as we note a lot of variability in our
experiments. Further experiments in this section will underline this
 observation. 
...
Table~\ref{tab:negative} shows that for the Frisian-Dutch corpus,
...
\hline
\multicolumn{7}{c}{Frysje Akademy -- Dutch$\rightarrow$Frisian} \\
