...
for corpus comparison is log-likelihood. Log likelihood allows you to identify
how indicative a pattern is for a particular corpus. Our implementation follows
the methodology of~\cite{Rayson00comparingcorpora}.
...
\begin{itemize}
    ...
    \item colibri-classdecode -- For decoding encoded corpus data, given a class
        encoding
    \item colibri-comparemodels -- Compares the frequency of patterns between
...
source under the GNU Public License (v3)\footnote{TODO}.
