...
the abstractions. The latter three relation types rely on both the \emph{forward
...
\begin{itemize}
    \item colibri-ngrams - Extracts n-grams of a particular size from the corpus text, in the order they occur, i.e. by moving a sliding window over the text.
