...
seconds. The Colibri Core implementation runs in $9.5$ seconds and takes just
$76$ MB, these gains can be attributed to the class encoding and the fact that
Colibri Core is implemented in C++.
