...
Colibri-core is single-threaded to the non-distributable nature of most of the
algorithms.
...
\indent \textbf{Name}: GitHub
\indent \textbf{Identifier}: \url{https://github.com/proycon/colibri-core}
\indent \textbf{Website}: \url{https://proycon.github.io/colibri-core}
\indent \textbf{Licence}: GNU General Public Licence v3
\indent \textbf{Date published}: since September 21st, 2013
