...
as explained in Section~\ref{sec:patterns}:
...
Section~\ref{sec:patternmodels}, to file:
...
We can now read the model from file and produce output in the form of 1) a print of all
patterns in the model, 2) a statistical report summarizing counts for various
groups of patterns, 3) a histogram of pattern frequencies:
...
extensive description of all available options and use cases, as this falls beyond
