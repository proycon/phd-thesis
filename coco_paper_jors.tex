...
\hline
$\ast$ Naive Python implementation & $484$ s & $11407$ MB \\
Unindexed Pattern Model (from file) & $258$ s & $1704$ MB ($1803$ MB) \\
Unindexed Pattern Model (preloaded corpus) & $238$ s & $1700$ MB ($1800$ MB) \\
Unindexed Pattern Model (preloaded corpus), with skipgrams & $3715$ s & $30420$ MB ($30520$ MB) \\
\end{tabular}
